...
$(window).scroll(function() {
  ...
  pxCtSpeed01 = $(document).scrollTop()/3;
  pxCtSpeed02 = $(document).scrollTop()/4;
  pxCtSpeed03 = $(document).scrollTop()/6;
  pxCtSpeed04 = $(document).scrollTop()/8;
  ...
  if (!(window.matchMedia('(prefers-reduced-motion)').matches)) {
    ...
    $(".speed-01").css({
      "bottom": +pxCtSpeed01+"px",
    });

    $(".speed-02").css({
      "bottom": +pxCtSpeed02+"px",
    });

    $(".speed-03").css({
      "bottom": +pxCtSpeed03+"px",
    });

    $(".speed-04").css({
      "bottom": +pxCtSpeed04+"px",
    });
